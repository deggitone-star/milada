...
export const products: Product[] = [
  ...
  { title: "Интегрированная ручка", slug: "pvh-int-ruchka", image: `${CDN}/v1778176590/milada/pvh-int-ruchka.png`, description: "Премиум фрезеровка с интегрированной ручкой.", category: "pvh-premium", material: "МДФ + ПВХ плёнка" },
  { title: "Инт. ручка 1", slug: "pvh-int-ruchka-1", image: "https://res.cloudinary.com/dx9tcpnkg/image/upload/v1778832136/milada/pvh-int-ruchka-1.png", description: "Интегрированная ручка, вариант 1. Безручечное решение для минималистичных интерьеров.", category: "pvh-premium", material: "МДФ + ПВХ плёнка" },
  { title: "Инт. ручка 2", slug: "pvh-int-ruchka-2", image: "https://res.cloudinary.com/dx9tcpnkg/image/upload/v1778832138/milada/pvh-int-ruchka-2.png", description: "Интегрированная ручка, вариант 2. Безручечное решение для современных кухонь.", category: "pvh-premium", material: "МДФ + ПВХ плёнка" },
  {
    title: "Лион",
    slug: "pvh-lion",
