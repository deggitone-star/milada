...
export const metadata: Metadata = {
  ...
  description:
    "Крашеные фасады МДФ от производителя MILADA в Ульяновске. Покраска эмалью: матовая, глянцевая, металлик. Любой цвет по каталогу RAL — 1600+ оттенков. Индивидуальный раскрой, доставка по России. ☎ +7 (8422) 27-82-02",
      ...
      <section className="section-py bg-bg-alt border-t border-line">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-4 text-ink-muted leading-relaxed">
            ...
            <p>
              Эмалевые фасады подходят для кухонь, гостиных, гардеробных и ванных комнат. Работаем с мебельными компаниями, салонами и дилерами по всей России.
            </p>
          </div>
