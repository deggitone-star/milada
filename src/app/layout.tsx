...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://res.cloudinary.com/dx9tcpnkg/image/upload/f_auto,q_auto,c_fill,w_1200,h_630/v1778775339/1_g3ao5n.png", width: 1200, height: 630, alt: "MILADA — Производство мебельных фасадов" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "MILADA — Мебельные фасады в Ульяновске",
    description: "Производство мебельных фасадов с 2012 года. Опт для бизнеса.",
    images: ["https://res.cloudinary.com/dx9tcpnkg/image/upload/f_auto,q_auto,c_fill,w_1200,h_630/v1778775339/1_g3ao5n.png"],
  },
  robots: {
    index: true,
    follow: true,
