...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "фасады мдф оптом от производителя",
    "поставщик мебельных фасадов ульяновск",
    "фасады для мебельных компаний оптом",
    "фасады для кухонного салона",
    "фасады для мебельного производства",
    "фасады оптом поволжье",
    "производитель фасадов для дилеров",
    "сотрудничество мебельные фасады",
    "фасады мдф опт розница ульяновск",
  ],
};
...
const audiences = [
  {
    ...
    text: "Серийные поставки фасадов МДФ, ПВХ, эмаль, HPL для производственных линий.",
  },
  {
    icon: "store",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Фасады МДФ с ПВХ-плёнкой (стандартные и премиум фрезеровки), пластиковые фасады HPL, эмалевые, патинированные, радиусные фасады, декоративные элементы, спинки кроватные, дверные панели и полотна для шкафов-купе.",
  },
  {
      ...
      >
        ...
        <div className="container-site relative z-10 py-16 lg:py-24">
          ...
          <h1 className="text-h1 font-medium text-white leading-tight max-w-3xl">
            Фасады для мебельных компаний и дилеров оптом
          </h1>
          <p className="mt-5 text-base lg:text-lg text-white/70 leading-relaxed max-w-2xl">
            Производство мебельных фасадов для мебельных компаний, салонов и цехов в Ульяновске. Оптовые поставки МДФ, ПВХ, HPL и эмали с доставкой по России.
          </p>
