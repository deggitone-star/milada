...
export const metadata: Metadata = {
  ...
  description:
    "Пластиковые фасады HPL от производителя MILADA в Ульяновске. Влагостойкие, устойчивы к царапинам и выгоранию, срок службы 20+ лет. Декоры: дерево, мрамор, камень, однотонные. Опт для бизнеса, доставка по России. ☎ +7 (8422) 27-82-02",
