...
export const metadata: Metadata = {
  title: "Каменные фасады для кухни от производителя — искусственный камень на МДФ | MILADA Ульяновск",
  description:
    "Каменные фасады МДФ от завода MILADA в Ульяновске. Искусственный камень с термостойким лаком, 18 однотонных + 8 перламутровых цветов. Уникальная текстура, индивидуальный раскрой. ☎ +7 (8422) 27-82-02",
  alternates: { canonical: `${siteConfig.url}/kamennye-fasady` },
  keywords: [
    "каменные фасады ульяновск",
    "фасады под камень для кухни",
    "каменные фасады мдф от производителя",
    "фасады из искусственного камня купить",
    "каменные мебельные фасады россия",
    "кухонные фасады под камень",
    "фасады с покрытием камень",
  ],
};
