          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                text: "МДФ с покрытием эмалью. Любой цвет по каталогу RAL — матовый, глянцевый, металлик. Семиэтапная технология.",
              },
              {
                href: "/hpl-fasady",
      ...
      <section className="section-py bg-bg">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-4 text-ink-muted leading-relaxed">
            ...
            <p>
              Работаем с мебельными компаниями, кухонными салонами и дилерами. Индивидуальный раскрой по вашим размерам, изготовление от 5 рабочих дней, доставка по всей России через транспортные компании.
            </p>
          </div>
