...
export const metadata: Metadata = {
  ...
  description: `${totalDecors} декоров пластика HPL для мебельных фасадов: дерево, мрамор, камень, однотонные, фантазийные. Производство фасадов — MILADA, Ульяновск. ☎ +7 (8422) 27-82-02`,
  alternates: { canonical: `${siteConfig.url}/catalog/plastic` },
  keywords: [
...
export default function PlasticCatalogPage() {
  const breadcrumbs = [
    { name: "Главная", url: siteConfig.url },
    { name: "Каталог", url: `${siteConfig.url}/catalog` },
    { name: "Пластик HPL", url: `${siteConfig.url}/catalog/plastic` },
  ];
  ...
  return (
    <>
      ...
      <CollectionPageSchema
        ...
        description={`${totalDecors} декоров пластика HPL для мебельных фасадов MILADA`}
        url={`${siteConfig.url}/catalog/plastic`}
        itemCount={totalDecors}
      />

      {/* HERO — стиль как у остальных категорий */}
      <section
      ...
      >
        <div className="absolute inset-0 z-0">
          <Image
            src={category.image}
            alt="Пластиковые фасады HPL — MILADA Ульяновск"
            fill
            sizes="100vw"
            ...
            <div>
              <div className="flex items-center gap-4 mb-5">
                <div className="w-14 h-14 rounded-soft bg-mint/15 backdrop-blur-sm flex items-center justify-center text-mint shrink-0">
                  <CategoryIcon slug="plastic" className="w-8 h-8" />
                </div>
                <p className="text-xs font-medium tracking-[0.15em] uppercase text-mint">Каталог декоров</p>
              </div>
              ...
              <p className="mt-5 text-base lg:text-lg text-white/70 leading-relaxed max-w-xl">
                {totalDecors} декоров пластика высокого давления в 4 коллекциях. Все декоры доступны для производства фасадов MILADA.
              </p>
            </div>
      ...
      {/* NAV — sticky навигация по коллекциям */}
      ...
      <section className="section-py bg-bg-alt border-t border-line">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-4 text-ink-muted leading-relaxed">
            ...
            <p>
              Коллекция «Индия» включает однотонные матовые и суперматовые декоры — от нежных бежево-пудровых до глубоких карамельных оттенков. Суперматовые поверхности устойчивы к царапинам, не бликуют на солнце и не оставляют отпечатков пальцев.
            </p>
            <p>
