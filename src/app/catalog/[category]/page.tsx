          ...
          <div className="container-site">
            ...
            <p className="text-ink-muted mb-8 max-w-2xl leading-relaxed">
              {slug === "radius"
                ...
                : slug === "enamel"
                ? "Выберите форму фасада в каталоге фрезеровок — выполним её в эмали любого цвета по RAL. Стандартные и премиум, все 47 моделей."
                : "Выберите форму фасада в каталоге фрезеровок — состарим её вручную поверх плёнки или эмали. Стандартные и премиум, все 47 моделей."}
            </p>
