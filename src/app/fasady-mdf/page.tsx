...
export const metadata: Metadata = {
  ...
  description:
    "Завод фасадов МДФ MILADA в Ульяновске. ПВХ-плёнка, эмаль по RAL, HPL-пластик, патина, камень. Стандартные и премиум фрезеровки, индивидуальный раскрой. Опт и розница, доставка по РФ. ☎ +7 (8422) 27-82-02",
