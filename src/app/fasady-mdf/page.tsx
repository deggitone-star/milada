...
export const metadata: Metadata = {
  title: "Фасады МДФ от производителя в Ульяновске — ПВХ, эмаль, HPL | MILADA",
  description:
    "Производство фасадов МДФ в Ульяновске. ПВХ-плёнка, эмаль, HPL-пластик. Стандартные и премиум фрезеровки, индивидуальный раскрой. Опт и розница. ☎ +7 (8422) 27-82-02",
  alternates: { canonical: `${siteConfig.url}/fasady-mdf` },
  keywords: [
    "фасады мдф",
    "фасады мдф от производителя",
    "фасады мдф ульяновск",
    "мдф фасады для кухни",
    "фасады мдф купить",
    "фасады мдф пвх",
    "мебельные фасады мдф",
    "фасады мдф оптом",
  ],
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-line">
            <div className="bg-bg-alt p-6 lg:p-8">
              ...
              <p className="text-sm text-ink-muted leading-relaxed">
                Декоративная плёнка наносится методом мембранно-вакуумного прессования. Более 100 декоров: однотонные, под дерево, металлик, глянец. Доступная цена, сложные 3D-фрезеровки.
              </p>
        ...
        <div className="container-site max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { title: "Разнообразие покрытий", text: "ПВХ-плёнка, эмаль, HPL-пластик, патина, камень — любое покрытие на одной основе." },
      ...
      <section className="section-py bg-bg-alt border-t border-line">
        <div className="container-site max-w-4xl">
          ...
          <div className="space-y-4 text-ink-muted leading-relaxed">
            ...
            <p>
              Условия для оптовых клиентов: работа по договору, отсрочка платежа, минимальный заказ от 50 м², доставка через проверенные транспортные компании с многослойной упаковкой. Срок изготовления стандартного заказа — от 5 рабочих дней.
            </p>
          </div>
