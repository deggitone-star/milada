...
export const metadata: Metadata = {
  title: "Производство мебельных фасадов в Ульяновске | MILADA",
  description:
    "Собственное производство мебельных фасадов MILADA в Ульяновске. Полный цикл: от МДФ-основы до готового фасада. Оборудование, технологии, контроль качества. ☎ +7 (8422) 27-82-02",
  alternates: { canonical: `${siteConfig.url}/proizvodstvo-fasadov` },
  keywords: [
    "производство фасадов", "производство мебельных фасадов",
    "производство фасадов ульяновск", "фабрика мебельных фасадов",
    "завод мебельных фасадов", "изготовление фасадов",
  ],
};
