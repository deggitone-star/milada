...
export const metadata: Metadata = {
  title: "Технические параметры фасадов МДФ — профили, лучи, рамки | MILADA Ульяновск",
  description:
    "Технические характеристики мебельных фасадов MILADA: профили торцов, типы лучей, обозначения исполнения рамок, допуски размеров. Документация для мебельных производств и проектировщиков. ☎ +7 (8422) 27-82-02",
  alternates: { canonical: `${siteConfig.url}/tekhnicheskie-parametry` },
  keywords: [
    "технические параметры фасадов мдф",
    "профиль торца фасада мдф",
    "типы фрезеровки фасадов",
    "размеры мебельных фасадов",
    "документация мебельные фасады",
    "чертежи фасадов мдф",
  ],
};
