...
const slides = [
  {
    ...
    subtitle: "Фасады МДФ, ПВХ-плёнка, эмаль и HPL-пластик для мебельных компаний, салонов и дилеров. Серийные модели и индивидуальные заказы.",
    mobileSubtitle: "МДФ, ПВХ, эмаль, HPL. Опт для бизнеса.",
  ...
  },
  {
    ...
    subtitle: "ПВХ-плёнка, эмаль RAL, HPL-пластик, патина, радиусные модели.",
    mobileSubtitle: "ПВХ, эмаль RAL, HPL, патина.",
