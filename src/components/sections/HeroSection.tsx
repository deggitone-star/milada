...
const slides = [
  {
    ...
    title: "Мебельные фасады от производителя",
    mobileTitle: "Мебельные фасады от производителя",
    subtitle: "ПВХ, эмаль, пластик HPL и патина для мебельных компаний, салонов и дилеров. Опт для бизнеса, серийные поставки и индивидуальный раскрой.",
    mobileSubtitle: "ПВХ, эмаль, пластик HPL, патина. Опт для бизнеса.",
    image: opt("https://res.cloudinary.com/dx9tcpnkg/image/upload/v1778775339/1_g3ao5n.png"),
  },
  {
    eyebrow: "С 2012 года",
    title: "Партнёр для мебельных фасадов",
    mobileTitle: "Партнёр для мебельных фасадов",
  ...
  {
    eyebrow: "Полный спектр покрытий",
    title: "Полный спектр фасадов",
    mobileTitle: "Полный спектр фасадов",
    subtitle: "ПВХ, эмаль, пластик HPL и патина — полный спектр покрытий для мебельных фасадов. Серийные модели и индивидуальные заказы.",
    mobileSubtitle: "ПВХ, эмаль, пластик HPL, патина.",
