const advantages = [
  {
    ...
    text: "Полный цикл изготовления на собственном заводе в Ульяновске. Работаем напрямую без посредников и торговых наценок.",
  },
  {
    num: "2",
    title: "Индивидуальный раскрой",
    text: "Изготавливаем фасады под точные размеры заказчика. Подходит и для серийных заказов мебельных производств, и для частных проектов.",
  },
  {
    num: "3",
