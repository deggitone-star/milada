const advantages = [
  {
    ...
    text: "Полный цикл изготовления на собственном производственном предприятии в Ульяновске. Работаем напрямую без посредников и торговых наценок.",
  },
  {
    num: "2",
  ...
  },
  {
    ...
    text: "Работаем на рынке мебельных фасадов с 2012 года. Среди клиентов — мебельные компании, кухонные салоны и дилеры Поволжья и других регионов.",
  },
];
